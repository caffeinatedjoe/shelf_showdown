...
Playful visual directions (not wired into the app yet) live in [`styles/index.html`](styles/index.html) — mobile-app phone frames including Soft Browse (pastel cover cards), Face Out, Ring Round, Stack Attack, Zine Fight, and Late Fee.
